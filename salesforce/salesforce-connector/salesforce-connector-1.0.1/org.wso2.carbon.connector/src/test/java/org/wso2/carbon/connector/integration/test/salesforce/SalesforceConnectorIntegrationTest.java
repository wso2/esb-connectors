...
public class SalesforceConnectorIntegrationTest extends ESBIntegrationTest {
    ...
    @Test(groups = {"wso2.esb"}, enabled = true, description = "Salesforce {describeGlobal} integration test.")
    ...
    @Test(groups = {"wso2.esb"}, enabled = true, description = "Salesforce {describeSObject} integration test.")
    ...
    @Test(groups = {"wso2.esb"}, enabled = true, description = "Salesforce {describeSObjects} integration test.")
    ...
    @Test(groups = {"wso2.esb"}, enabled = true, description = "Salesforce {query} integration test.")
    ...
    @Test(groups = {"wso2.esb"}, enabled = true, description = "Salesforce {queryAll} integration test.")
    ...
    @Test(groups = {"wso2.esb"}, enabled = true, description = "Salesforce {queryMore} integration test.")
    ...
    @Test(groups = {"wso2.esb"}, enabled = true, description = "Salesforce {search} integration test.")
    ...
    @Test(groups = {"wso2.esb"}, enabled = true, description = "Salesforce {sendMail} integration test.")
    ...
    @Test(groups = {"wso2.esb"}, enabled = true, description = "Salesforce {setPassword} integration test.")
    ...
    @Test(groups = {"wso2.esb"}, enabled = true, description = "Salesforce {create} integration test.")
    ...
    @Test(groups = {"wso2.esb"}, enabled = true, description = "Salesforce {update} integration test.")
    ...
    @Test(groups = {"wso2.esb"}, enabled = true, description = "Salesforce {delete} integration test.")
    ...
    @Test(groups = {"wso2.esb"}, enabled = true, description = "Salesforce {undelete} integration test.")
    ...
    @Test(groups = {"wso2.esb"}, enabled = true, description = "Salesforce {emptyRecycleBin} integration test.")
    ...
    @Test(groups = {"wso2.esb"}, enabled = true, description = "Salesforce {upsert} integration test.")
    ...
    @Test(groups = {"wso2.esb"}, enabled = true, description = "Salesforce {ResetPassword} integration test.")
