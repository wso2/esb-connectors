...
public class SalesforceRestConnectorIntegrationTest extends ConnectorIntegrationTestBase {
    ...
    public void sObjectGetDeleted() throws IOException, JSONException {
        ...
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/services/data/"+ connectorProperties.getProperty("apiVersion")+"/sobjects/"+connectorProperties.getProperty("sobject")+"/deletd/?start="+connectorProperties.getProperty("startTime")+"&end="+connectorProperties.getProperty("endTime");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
    ...
    public void sObjectGetUpdated() throws IOException, JSONException {
        ...
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/services/data/"+ connectorProperties.getProperty("apiVersion")+"/sobjects/"+connectorProperties.getProperty("sobject")+"/updated/?start="+connectorProperties.getProperty("startTime")+"&end="+connectorProperties.getProperty("endTime");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
    ...
    public void getSpecificAction() throws IOException, JSONException {
        ...
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/services/data/"+ connectorProperties.getProperty("apiVersion")+"/sobjects/"+connectorProperties.getProperty("sobject")+"/quickActions/"+connectorProperties.getProperty("actionName");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(apiRestResponse.getHttpStatusCode(), 404);
    }
    ...
    public void retrieveFieldValues() throws IOException, JSONException {
        ...
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/services/data/"+ connectorProperties.getProperty("apiVersion")+"/sobjects/"+connectorProperties.getProperty("sobject")+connectorProperties.getProperty("rowValue")+"?fields="+connectorProperties.getProperty("fields");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(apiRestResponse.getHttpStatusCode(), 404);
    }
...
//        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
//        System.out.println("ESBESBESBESBESBESBESBESBESBESB" + esbRestResponse.getBody().toString());
