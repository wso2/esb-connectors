...
Steps to follow in setting integration test.
 ...
 3. Compress modified ESB as wso2esb-4.8.1.zip and copy that zip file in to location "{tsheets_Connector_Home}/tsheets-connector/tsheets-connector-1.0.0/org.wso2.carbon.connector/repository/".
 ...
 8. Navigate to "{tsheets_connector_Home}/tsheets-connector/tsheets-connector-1.0.0/org.wso2.carbon.connector/" and run the following command.
      $ mvn clean install
