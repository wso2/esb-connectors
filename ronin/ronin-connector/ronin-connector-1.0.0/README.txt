...
Steps to follow in setting integration test.
 ...
 4. Compress the modified ESB as wso2esb-4.8.1.zip and copy that zip file in to location "<RONIN_CONNECTOR_HOME>/ronin-connector/ronin-connector-1.0.0/org.wso2.carbon.connector/repository/".

 5. Create a Ronin trial account and login.
 ...
 6. Prerequisites for Ronin Connector Integration Testing
 ...
 7. Update the Ronin properties file at location "<RONIN_CONNECTOR_HOME>/ronin-connector/ronin-connector-1.0.0/org.wso2.carbon.connector/src/test/resources/artifacts/ESB/connector/config" as below.
 ...
 8. Navigate to "<RONIN_CONNECTOR_HOME>/ronin-connector/ronin-connector-1.0.0/org.wso2.carbon.connector/" and run the following command.
      $ mvn clean install
