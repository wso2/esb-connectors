...
public class Blpop extends AbstractMediator {
    ...
    public boolean mediate(MessageContext messageContext) {
        try {
            ...
            if (jedis != null) {
                ...
                Integer brpopTimeout = Integer.parseInt(messageContext.getProperty(RedisConstants.BLPOPTIMEOUT).toString());
                ...
                for (int i = 0; i <= keyvalue.length; i++) {
                    ...
                    response = jedis.blpop(brpopTimeout, keyvalue[i]);
                }
                if (response != null) {
