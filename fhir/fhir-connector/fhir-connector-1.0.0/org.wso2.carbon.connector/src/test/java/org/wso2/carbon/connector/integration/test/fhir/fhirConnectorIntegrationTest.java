...
//     */
//    @Test(enabled = true, description = "fhir {readSpecificResourceById} integration test with mandatory parameters.")
...
//        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(getProxyServiceURL(methodName), "POST", esbRequestHeadersMap, "readSpecificResourceByIdMandatory.json");
