...
Steps to follow in setting integration test.
 ...
 7. Prerequisites for twilioRest Connector Integration Testing
	...
	iii) Similarly work with sms ,calls and phone numbers
 ...
 8. Update the twilio properties file at location "<TWILIOREST_CONNECTOR_HOME>/twilioRest-connector/twilioRest-connector-1.0.0/org.wso2.carbon.connector/src/test/resources/artifacts/ESB/connector/config" as below.  
	...
	v)		friendlyname		 -	A String value for the opportunity name to create an opportunity with optional parameters.
	vi)		status				 -	3 character ISO currency code (e.g. USD).
	vii)	need to fill		 -	A String value for the opportunity description to create an opportunity with optional parameters.
	viii)	need to fill		 -	A String value for the case name to create a case with mandatory parameters.
	ix)		need to fill		 -	A String value for the case name to create a case with optional parameters.
	x)		need to fill		 -	A String value for the case description to create a case with optional parameters.
