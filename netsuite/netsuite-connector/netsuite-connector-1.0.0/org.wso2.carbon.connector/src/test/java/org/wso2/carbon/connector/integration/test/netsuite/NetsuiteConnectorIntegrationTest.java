...
public class NetsuiteConnectorIntegrationTest extends
	...
	public void testAddListWithMandatoryParameters() throws Exception {
		...
		nameSpaceMap.put("listRel",
				"urn:relationships_2014_1.lists.webservices.netsuite.com");

		SOAPEnvelope esbSoapResponse = sendSOAPRequest(proxyUrl,
				"esb_addList_mandatory.xml", null, "mediate",
		...
		Boolean isSuccess = Boolean.valueOf((String) xPathEvaluate(
				esbResponseElement, xPathExp, nameSpaceMap));

		String internalId;
		if (isSuccess.booleanValue()) {
			xPathExp = "string(/soapenv:Body/ns:addListResponse/ns:writeResponseList/ns:writeResponse/ns:baseRef/@internalId)";
			internalId = (String) xPathEvaluate(esbResponseElement, xPathExp,
					nameSpaceMap);
		...
		SOAPEnvelope apiSoapResponse = sendSOAPRequest(apiEndPoint,
				"api_addList_mandatory.xml", null, "getList",
				SOAP_HEADER_XPATH_EXP, SOAP_BODY_XPATH_EXP);
		...
		String apiEntityId = (String) xPathEvaluate(apiResponseElement,
		...
		String apicompanyName = (String) xPathEvaluate(apiResponseElement,
				xPathExp, nameSpaceMap);
		...
		String subsidiary = (String) xPathEvaluate(apiResponseElement,
				xPathExp, nameSpaceMap);

		Assert.assertEquals(apiEntityId,
				connectorProperties.getProperty("customerNameMandatory"));
		Assert.assertEquals(apicompanyName,
				connectorProperties.getProperty("companyName"));
		Assert.assertEquals(subsidiary,
				connectorProperties.getProperty("subsidiaryId"));
	...
	public void testAddListWithOptionalParameters() throws Exception {
		...
		SOAPEnvelope esbSoapResponse = sendSOAPRequest(proxyUrl,
				"esb_addList_optional.xml", null, "mediate",
				SOAP_HEADER_XPATH_EXP, SOAP_BODY_XPATH_EXP);
		...
		SOAPEnvelope apiSoapResponse = sendSOAPRequest(apiEndPoint,
				"api_addList_optional.xml", null, "getList",
				SOAP_HEADER_XPATH_EXP, SOAP_BODY_XPATH_EXP);
		...
		Assert.assertEquals(comment,
				connectorProperties.getProperty("customerComment"));
	...
	public void testAddListWithNegativeCase() throws Exception {
		...
		SOAPEnvelope esbSoapResponse = sendSOAPRequest(proxyUrl,
				"esb_addList_negative.xml", null, "mediate",
				SOAP_HEADER_XPATH_EXP, SOAP_BODY_XPATH_EXP);

		SOAPEnvelope apiSoapResponse = sendSOAPRequest(apiEndPoint,
				"api_addList_negative.xml", null, "addList",
				SOAP_HEADER_XPATH_EXP, SOAP_BODY_XPATH_EXP);
		...
		String xPathExp = "string(/soapenv:Body/ns:addListResponse/ns:writeResponseList/ns:writeResponse/platformCore:status/@isSuccess)";
		String esbIsSuccess = (String) xPathEvaluate(esbResponseElement,
				xPathExp, nameSpaceMap);
		String apiIsSuccess = (String) xPathEvaluate(apiResponseElement,
				xPathExp, nameSpaceMap);
		...
		String esbType = (String) xPathEvaluate(esbResponseElement, xPathExp,
				nameSpaceMap);
		String apiType = (String) xPathEvaluate(apiResponseElement, xPathExp,
				nameSpaceMap);
		...
		String esbCode = (String) xPathEvaluate(esbResponseElement, xPathExp,
				nameSpaceMap);
		String apiCode = (String) xPathEvaluate(apiResponseElement, xPathExp,
				nameSpaceMap);
	...
	public void testGetListWithMandatoryParameters() throws Exception {
		...
		SOAPEnvelope esbSoapResponse = sendSOAPRequest(proxyUrl,
				"esb_getList_mandatory.xml", null, "mediate",
				SOAP_HEADER_XPATH_EXP, SOAP_BODY_XPATH_EXP);

		SOAPEnvelope apiSoapResponse = sendSOAPRequest(apiEndPoint,
				"api_getList_mandatory.xml", null, "getList",
				SOAP_HEADER_XPATH_EXP, SOAP_BODY_XPATH_EXP);
		...
		String esbEntityId = (String) xPathEvaluate(esbResponseElement,
				xPathExp, nameSpaceMap);
		String apiEntityId = (String) xPathEvaluate(apiResponseElement,
				xPathExp, nameSpaceMap);

		xPathExp = "string(/soapenv:Body/ns:getListResponse/ns:readResponseList/ns:readResponse/ns:record/listRel:companyName/text())";
		String esbCompanyName = (String) xPathEvaluate(esbResponseElement,
				xPathExp, nameSpaceMap);
		String apiCompanyName = (String) xPathEvaluate(apiResponseElement,
				xPathExp, nameSpaceMap);

		xPathExp = "string(/soapenv:Body/ns:getListResponse/ns:readResponseList/ns:readResponse/ns:record/listRel:subsidiary/@internalId)";
		String esbSubsidiary = (String) xPathEvaluate(esbResponseElement,
				xPathExp, nameSpaceMap);
		String apiSubsidiary = (String) xPathEvaluate(apiResponseElement,
				xPathExp, nameSpaceMap);
		...
		String esbCustomFormId = (String) xPathEvaluate(esbResponseElement,
				xPathExp, nameSpaceMap);
		String apiCustomFormId = (String) xPathEvaluate(apiResponseElement,
				xPathExp, nameSpaceMap);
		...
		String esbCustomFormName = (String) xPathEvaluate(esbResponseElement,
				xPathExp, nameSpaceMap);
		String apiCustomFormName = (String) xPathEvaluate(apiResponseElement,
				xPathExp, nameSpaceMap);
	...
	public void testGetListWithNegativeCase() throws Exception {
		...
		SOAPEnvelope esbSoapResponse = sendSOAPRequest(proxyUrl,
				"esb_getList_negative.xml", null, "mediate",
				SOAP_HEADER_XPATH_EXP, SOAP_BODY_XPATH_EXP);

		String apiEndPoint = connectorProperties.getProperty("apiUrl");
		SOAPEnvelope apiSoapResponse = sendSOAPRequest(apiEndPoint,
				"api_getList_negative.xml", null, "getList",
				SOAP_HEADER_XPATH_EXP, SOAP_BODY_XPATH_EXP);
	...
	public void testUpdateListWithMandatoryParameters() throws Exception {
		...
		SOAPEnvelope esbSoapResponse = sendSOAPRequest(proxyUrl,
				"esb_updateList_mandatory.xml", null, "mediate",
				SOAP_HEADER_XPATH_EXP, SOAP_BODY_XPATH_EXP);
		...
		Boolean isEsbSuccess = Boolean.valueOf((String) xPathEvaluate(
				esbResponseElement, xPathExp, nameSpaceMap));

		Assert.assertTrue(isEsbSuccess.booleanValue());

		SOAPEnvelope apiSoapResponse = sendSOAPRequest(apiEndPoint,
				"api_updateList_mandatory.xml", null, "getList",
				SOAP_HEADER_XPATH_EXP, SOAP_BODY_XPATH_EXP);
		...
		Assert.assertEquals(apiEntityId,
				connectorProperties.getProperty("customerNameUpdated"));
		Assert.assertEquals(apicompanyName,
				connectorProperties.getProperty("companyNameUpdated"));
	...
	public void testUpdateListWithNegative() throws Exception {
		...
		SOAPEnvelope esbSoapResponse = sendSOAPRequest(proxyUrl,
				"esb_updateList_negative.xml", null, "mediate",
				SOAP_HEADER_XPATH_EXP, SOAP_BODY_XPATH_EXP);

		SOAPEnvelope apiSoapResponse = sendSOAPRequest(apiEndPoint,
				"api_updateList_negative.xml", null, "updateList",
				SOAP_HEADER_XPATH_EXP, SOAP_BODY_XPATH_EXP);
	...
	public void testDeleteListWithMandatoryParameters() throws Exception {
		...
		SOAPEnvelope apiSoapResponse = sendSOAPRequest(apiEndPoint,
				"api_deleteList_mandatory.xml", null, "getList",
				SOAP_HEADER_XPATH_EXP, SOAP_BODY_XPATH_EXP);
		...
		String xPathExp = "string(/soapenv:Body/ns:getListResponse/ns:readResponseList/ns:readResponse/platformCore:status/@isSuccess)";
		Boolean isApiSuccess = Boolean.valueOf((String) xPathEvaluate(
				apiResponseElement, xPathExp, nameSpaceMap));

		// Test List is existing or not via direct call
		Assert.assertTrue(isApiSuccess.booleanValue());

		SOAPEnvelope esbSoapResponse = sendSOAPRequest(proxyUrl,
				"esb_deleteList_mandatory.xml", null, "mediate",
				SOAP_HEADER_XPATH_EXP, SOAP_BODY_XPATH_EXP);
		...
		apiSoapResponse = sendSOAPRequest(apiEndPoint,
				"api_deleteList_mandatory.xml", null, "getList",
				SOAP_HEADER_XPATH_EXP, SOAP_BODY_XPATH_EXP);

		apiResponseElement = AXIOMUtil.stringToOM(apiSoapResponse.getBody()
				.toString());

		xPathExp = "string(/soapenv:Body/ns:getListResponse/ns:readResponseList/ns:readResponse/platformCore:status/@isSuccess)";
		Boolean isItemExists = Boolean.valueOf((String) xPathEvaluate(
				apiResponseElement, xPathExp, nameSpaceMap));
	...
	public void testDeleteListWithNegative() throws Exception {
		...
		SOAPEnvelope esbSoapResponse = sendSOAPRequest(proxyUrl,
				"esb_deleteList_negative.xml", null, "mediate",
				SOAP_HEADER_XPATH_EXP, SOAP_BODY_XPATH_EXP);

		SOAPEnvelope apiSoapResponse = sendSOAPRequest(apiEndPoint,
				"api_deleteList_negative.xml", null, "deleteList",
				SOAP_HEADER_XPATH_EXP, SOAP_BODY_XPATH_EXP);
	...
	public void testGetCustomizationIdWithMandatoryParameters()
		...
		SOAPEnvelope esbSoapResponse = sendSOAPRequest(proxyUrl,
				"esb_getCustomizationId_mandatory.xml", null, "mediate",
				SOAP_HEADER_XPATH_EXP, SOAP_BODY_XPATH_EXP);

		String apiEndPoint = connectorProperties.getProperty("apiUrl");
		SOAPEnvelope apiSoapResponse = sendSOAPRequest(apiEndPoint,
				"api_getCustomizationId_mandatory.xml", null,
				"getCustomizationId", SOAP_HEADER_XPATH_EXP,
				SOAP_BODY_XPATH_EXP);

		OMElement esbRequestElement = AXIOMUtil.stringToOM(esbSoapResponse
				.getBody().toString());
		OMElement apiRequestElement = AXIOMUtil.stringToOM(apiSoapResponse
				.getBody().toString());
		...
		Boolean isEsbSuccess = Boolean.valueOf((String) xPathEvaluate(
				esbRequestElement, xpathString, nameSpaceMap));
		Boolean isApiSuccess = Boolean.valueOf((String) xPathEvaluate(
				apiRequestElement, xpathString, nameSpaceMap));
		...
		String esbTotalRecords = xPathEvaluate(esbRequestElement, xpathString,
				nameSpaceMap).toString();
		String apiTotalRecords = xPathEvaluate(apiRequestElement, xpathString,
				nameSpaceMap).toString();
		...
		String esbName = xPathEvaluate(esbRequestElement, xpathString,
				nameSpaceMap).toString();
		String apiName = xPathEvaluate(apiRequestElement, xpathString,
				nameSpaceMap).toString();
	...
	public void testGetCustomizationIdNegativeCase() throws Exception {
		...
		try {
			...
			SOAPEnvelope esbSoapResponse = sendSOAPRequest(proxyUrl,
					"esb_getCustomizationId_negative.xml", null, "mediate",
					SOAP_HEADER_XPATH_EXP, SOAP_BODY_XPATH_EXP);
		...
		try {
			...
			SOAPEnvelope apiSoapResponse = sendSOAPRequest(apiEndPoint,
					"api_getCustomizationId_negative.xml", null,
					"getCustomizationId", SOAP_HEADER_XPATH_EXP,
					SOAP_BODY_XPATH_EXP);
	...
	public void testAttachWithMandatoryParameters() throws Exception {
		...
		SOAPEnvelope esbSoapResponse = sendSOAPRequest(proxyUrl,
				"esb_attach_mandatory.xml", null, "mediate",
				SOAP_HEADER_XPATH_EXP, SOAP_BODY_XPATH_EXP);

		String apiEndPoint = connectorProperties.getProperty("apiUrl");
		SOAPEnvelope apiSoapResponse = sendSOAPRequest(apiEndPoint,
				"api_attach_mandatory.xml", null, "attach",
				SOAP_HEADER_XPATH_EXP, SOAP_BODY_XPATH_EXP);
		...
		String esbAttachInternalId = xPathEvaluate(esbRequestElement,
				xpathString, nameSpaceMap).toString();
		String apiAttachInternalId = xPathEvaluate(apiRequestElement,
				xpathString, nameSpaceMap).toString();
	...
	public void testAttachNegativeCase() throws Exception {
		...
		SOAPEnvelope esbSoapResponse = sendSOAPRequest(proxyUrl,
				"esb_attach_negative.xml", null, "mediate",
				SOAP_HEADER_XPATH_EXP, SOAP_BODY_XPATH_EXP);

		String apiEndPoint = connectorProperties.getProperty("apiUrl");
		SOAPEnvelope apiSoapResponse = sendSOAPRequest(apiEndPoint,
				"api_attach_negative.xml", null, "attach",
				SOAP_HEADER_XPATH_EXP, SOAP_BODY_XPATH_EXP);
		...
		String esbStatusDetail = xPathEvaluate(esbRequestElement, xpathString,
				nameSpaceMap).toString();
		String apiStatusDetail = xPathEvaluate(apiRequestElement, xpathString,
				nameSpaceMap).toString();
		...
		String esbCode = xPathEvaluate(esbRequestElement, xpathString,
				nameSpaceMap).toString();
		String apiCode = xPathEvaluate(apiRequestElement, xpathString,
				nameSpaceMap).toString();
	...
	public void testDetachWithMandatoryParameters() throws Exception {
		...
		SOAPEnvelope esbSoapResponse = sendSOAPRequest(proxyUrl,
				"esb_detach_mandatory.xml", null, "mediate",
				SOAP_HEADER_XPATH_EXP, SOAP_BODY_XPATH_EXP);

		String apiEndPoint = connectorProperties.getProperty("apiUrl");
		SOAPEnvelope apiSoapResponse = sendSOAPRequest(apiEndPoint,
				"api_detach_mandatory.xml", null, "detach",
				SOAP_HEADER_XPATH_EXP, SOAP_BODY_XPATH_EXP);
		...
		xpathString = "string(/soapenv:Body/attachResponse/writeResponse/platformCore:status/baseRef/@internalId)";
		String esbDetachInternalId = xPathEvaluate(esbRequestElement,
				xpathString, nameSpaceMap).toString();
		String apiDetachInternalId = xPathEvaluate(apiRequestElement,
				xpathString, nameSpaceMap).toString();

		xpathString = "string(/soapenv:Body/attachResponse/writeResponse/platformCore:status/baseRef/@type)";
		String esbType = xPathEvaluate(esbRequestElement, xpathString,
				nameSpaceMap).toString();
		String apiType = xPathEvaluate(apiRequestElement, xpathString,
				nameSpaceMap).toString();
	...
	public void testDetachNegativeCase() throws Exception {
		...
		SOAPEnvelope esbSoapResponse = sendSOAPRequest(proxyUrl,
				"esb_detach_negative.xml", null, "mediate",
				SOAP_HEADER_XPATH_EXP, SOAP_BODY_XPATH_EXP);

		String apiEndPoint = connectorProperties.getProperty("apiUrl");
		SOAPEnvelope apiSoapResponse = sendSOAPRequest(apiEndPoint,
				"api_detach_negative.xml", null, "detach",
				SOAP_HEADER_XPATH_EXP, SOAP_BODY_XPATH_EXP);
		OMElement esbRequestElement = AXIOMUtil.stringToOM(esbSoapResponse
				.getBody().toString());
		OMElement apiRequestElement = AXIOMUtil.stringToOM(apiSoapResponse
	...
	public void testGetDataCenterUrlsWithMandatoryParameters() throws Exception {
		...
		SOAPEnvelope esbSoapResponse = sendSOAPRequest(proxyUrl,
				"esb_getDataCenterUrls_mandatory.xml", null, "mediate",
				SOAP_HEADER_XPATH_EXP, SOAP_BODY_XPATH_EXP);

		String apiEndPoint = connectorProperties.getProperty("apiUrl");
		SOAPEnvelope apiSoapResponse = sendSOAPRequest(apiEndPoint,
				"api_getDataCenterUrls_mandatory.xml", null,
		...
		String esbRestDomain = xPathEvaluate(esbRequestElement, xpathString,
				nameSpaceMap).toString();
		String apiRestDomain = xPathEvaluate(apiRequestElement, xpathString,
				nameSpaceMap).toString();
		...
		String esbWebservicesDomain = xPathEvaluate(esbRequestElement,
				xpathString, nameSpaceMap).toString();
		String apiWebservicesDomain = xPathEvaluate(apiRequestElement,
				xpathString, nameSpaceMap).toString();
	...
	public void testGetDataCenterUrlsNegativeCase() throws Exception {
		...
		SOAPEnvelope esbSoapResponse = sendSOAPRequest(proxyUrl,
				"esb_getDataCenterUrls_negative.xml", null, "mediate",
				SOAP_HEADER_XPATH_EXP, SOAP_BODY_XPATH_EXP);

		String apiEndPoint = connectorProperties.getProperty("apiUrl");
		SOAPEnvelope apiSoapResponse = sendSOAPRequest(apiEndPoint,
				"api_getDataCenterUrls_negative.xml", null,
				"getDataCenterUrls", SOAP_HEADER_XPATH_EXP, SOAP_BODY_XPATH_EXP);
	...
	public void testSearchWithMandatoryParameters() throws Exception {
		...
		nameSpaceMap.put("platformCore",
				"urn:core_2014_1.platform.webservices.netsuite.com");
		nameSpaceMap.put("listEmp",
				"urn:employees_2014_1.lists.webservices.netsuite.com");

		SOAPEnvelope esbSoapResponse = sendSOAPRequest(proxyUrl,
				"esb_search_mandatory.xml", null, "mediate",
				SOAP_HEADER_XPATH_EXP, SOAP_BODY_XPATH_EXP);

		String apiEndPoint = connectorProperties.getProperty("apiUrl");
		SOAPEnvelope apiSoapResponse = sendSOAPRequest(apiEndPoint,
				"api_search_mandatory.xml", null, "search",
				SOAP_HEADER_XPATH_EXP, SOAP_BODY_XPATH_EXP);
		OMElement esbRequestElement = AXIOMUtil.stringToOM(esbSoapResponse
				.getBody().toString());
		OMElement apiRequestElement = AXIOMUtil.stringToOM(apiSoapResponse
		...
		String esbEntityId = xPathEvaluate(esbRequestElement, xpathString,
				nameSpaceMap).toString();
		String apiEntityId = xPathEvaluate(apiRequestElement, xpathString,
				nameSpaceMap).toString();
	...
	public void testSearchNegativeCase() throws Exception {
		...
		try {
			SOAPEnvelope apiSoapResponse = sendSOAPRequest(apiEndPoint,
					"api_search_negative.xml", null, "search",
					SOAP_HEADER_XPATH_EXP, SOAP_BODY_XPATH_EXP);
		} catch (AxisFault af) {
			apiFaultCode = af.getMessage();
			apiFaultCodeElement = af.getFaultCodeElement().getText();
	...
	public void testGetAllWithMandatoryParameters() throws Exception {
		...
		nameSpaceMap.put("listAcct",
				"urn:accounting_2014_1.lists.webservices.netsuite.com");

		SOAPEnvelope esbSoapResponse = sendSOAPRequest(proxyUrl,
				"esb_getAll_mandatory.xml", null, "mediate",
				SOAP_HEADER_XPATH_EXP, SOAP_BODY_XPATH_EXP);
		OMElement esbResponseElement = AXIOMUtil.stringToOM(esbSoapResponse
				.getBody().toString());

		SOAPEnvelope apiSoapResponse = sendSOAPRequest(apiEndPoint,
				"api_getAll_mandatory.xml", null, "getAll",
				SOAP_HEADER_XPATH_EXP, SOAP_BODY_XPATH_EXP);
		OMElement apiResponseElement = AXIOMUtil.stringToOM(apiSoapResponse
				.getBody().toString());
		...
		String esbTotalRecords = xPathEvaluate(esbResponseElement, xpathString,
				nameSpaceMap).toString();
		String apiTotalRecords = xPathEvaluate(apiResponseElement, xpathString,
				nameSpaceMap).toString();
		...
		String esbCountry = xPathEvaluate(esbResponseElement, xpathString,
				nameSpaceMap).toString();
		String apiCountry = xPathEvaluate(apiResponseElement, xpathString,
				nameSpaceMap).toString();
	...
	public void testGetItemAvailabilityWithMandatoryParameters()
		...
		SOAPEnvelope apiSoapResponse = sendSOAPRequest(apiEndPoint,
				"api_getItemAvailability_mandatory.xml", null,
		...
		String esbItemName = xPathEvaluate(esbResponseElement, xpathString,
				nameSpaceMap).toString();
		String apiItemName = xPathEvaluate(apiResponseElement, xpathString,
				nameSpaceMap).toString();
		...
		xpathString = "number(/soapenv:Envelope/soapenv:Body/ns:getItemAvailabilityResponse/platformCore:getItemAvailabilityResult/platformCore:itemAvailabilityList/platformCore:itemAvailability/platformCore:quantityOnHand)"
				.toString();
		String esbQuantityOnHand = xPathEvaluate(esbResponseElement,
				xpathString, nameSpaceMap).toString();
		String apiQuantityOnHand = xPathEvaluate(apiResponseElement,
				xpathString, nameSpaceMap).toString();
		...
		xpathString = "number(/soapenv:Envelope/soapenv:Body/ns:getItemAvailabilityResponse/platformCore:getItemAvailabilityResult/platformCore:itemAvailabilityList/platformCore:itemAvailability/platformCore:quantityOnOrder)"
				.toString();
		String esbQuantityOnOrder = xPathEvaluate(esbResponseElement,
				xpathString, nameSpaceMap).toString();
		String apiQuantityOnOrder = xPathEvaluate(apiResponseElement,
				xpathString, nameSpaceMap).toString();
	...
	public void testGetItemAvailabilityWithOptionalParameters()
		...
		SOAPEnvelope esbSoapResponse = sendSOAPRequest(proxyUrl,
				"esb_getItemAvailability_optional.xml", null, "mediate",
				SOAP_HEADER_XPATH_EXP, SOAP_BODY_XPATH_EXP);
		OMElement esbResponseElement = AXIOMUtil.stringToOM(esbSoapResponse
				.getBody().toString());

		SOAPEnvelope apiSoapResponse = sendSOAPRequest(apiEndPoint,
				"api_getItemAvailability_optional.xml", null,
				"getItemAvailability", SOAP_HEADER_XPATH_EXP,
				SOAP_BODY_XPATH_EXP);
		OMElement apiResponseElement = AXIOMUtil.stringToOM(apiSoapResponse
				.getBody().toString());
		...
		String esbLastQtyAvailableChange = xPathEvaluate(esbResponseElement,
				xpathString, nameSpaceMap).toString();
		String apiLastQtyAvailableChange = xPathEvaluate(apiResponseElement,
				xpathString, nameSpaceMap).toString();

		Assert.assertEquals(apiIsSuccess, esbIsSuccess);
		Assert.assertEquals(apiItemName, esbItemName);
		Assert.assertEquals(apiQuantityOnHand, esbQuantityOnHand);
		Assert.assertEquals(apiLastQtyAvailableChange,
				esbLastQtyAvailableChange);
	...
	public void testGetItemAvailabilityWithNegativeCase() throws Exception {
		...
		try {
			...
			sendSOAPRequest(apiEndPoint,
					"api_getItemAvailability_negative.xml", null,
					"getItemAvailability", SOAP_HEADER_XPATH_EXP,
					SOAP_BODY_XPATH_EXP);
	...
	public void testGetSelectValueWithMandatoryParameters() throws Exception {
		...
		xpathString = "string(/soapenv:Body/ns:getSelectValueResponse/platformCore:getSelectValueResult/platformCore:baseRefList/platformCore:baseRef[1]/@internalId)"
				.toString();
		String esbInternalId = xPathEvaluate(esbResponseElement, xpathString,
				nameSpaceMap).toString();
		String apiInternalId = xPathEvaluate(apiResponseElement, xpathString,
				nameSpaceMap).toString();
		...
		xpathString = "number(/soapenv:Body/ns:getSelectValueResponse/platformCore:getSelectValueResult/totalPages)"
				.toString();
		String esbTotalPages = xPathEvaluate(esbResponseElement, xpathString,
				nameSpaceMap).toString();
		String apiTotalPages = xPathEvaluate(apiResponseElement, xpathString,
				nameSpaceMap).toString();
	...
	public void testGetSelectValueWithOptionalParameters() throws Exception {
		...
		SOAPEnvelope esbSoapResponse = sendSOAPRequest(proxyUrl,
				"esb_getSelectValue_optional.xml", null, "mediate",
				SOAP_HEADER_XPATH_EXP, SOAP_BODY_XPATH_EXP);
		OMElement esbResponseElement = AXIOMUtil.stringToOM(esbSoapResponse
				.getBody().toString());

		SOAPEnvelope apiSoapResponse = sendSOAPRequest(apiEndPoint,
				"api_getSelectValue_optional.xml", null, "getSelectValue",
				SOAP_HEADER_XPATH_EXP, SOAP_BODY_XPATH_EXP);
		OMElement apiResponseElement = AXIOMUtil.stringToOM(apiSoapResponse
				.getBody().toString());
	...
	public void testInitializeListWithMandatoryParameters() throws Exception {
		...
		SOAPEnvelope esbSoapResponse = sendSOAPRequest(proxyUrl,
				"esb_initializeList_mandatory.xml", null, "mediate",
				SOAP_HEADER_XPATH_EXP, SOAP_BODY_XPATH_EXP);
		OMElement esbResponseElement = AXIOMUtil.stringToOM(esbSoapResponse
				.getBody().toString());

		SOAPEnvelope apiSoapResponse = sendSOAPRequest(apiEndPoint,
				"api_initializeList_mandatory.xml", null, "initializeList",
				SOAP_HEADER_XPATH_EXP, SOAP_BODY_XPATH_EXP);
		OMElement apiResponseElement = AXIOMUtil.stringToOM(apiSoapResponse
				.getBody().toString());
	...
	public void testInitializeListWithNegativeCase() throws Exception {
		...
		try {
			...
			sendSOAPRequest(apiEndPoint, "api_initializeList_negative.xml",
					null, "initializeList", SOAP_HEADER_XPATH_EXP,
					SOAP_BODY_XPATH_EXP);
