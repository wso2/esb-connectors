...
public class SpotifyConnectorIntegrationTest extends ESBIntegrationTest {
    ...
    public void testTokenFromCode() throws Exception {
        ...
        final String proxyFilePath = "file:///" + pathToProxiesDirectory + methodName + ".xml";
        proxyAdmin.addProxyService(new DataHandler(new URL(proxyFilePath)));
        String modifiedJsonString = String.format(jsonString, accessCode, spotifyConnectorProperties.getProperty("redirect_uri"), spotifyConnectorProperties.getProperty("client_id"), spotifyConnectorProperties.getProperty("client_secret"));
        try {
