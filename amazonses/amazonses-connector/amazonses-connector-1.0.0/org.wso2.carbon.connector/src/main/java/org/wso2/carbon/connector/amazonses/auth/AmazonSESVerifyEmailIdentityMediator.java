...
/**
 * The Class AmazonSESVerifyEmailIdentityMediator used for verifyEmailIdentity method.
 */
public class AmazonSESVerifyEmailIdentityMediator extends AmazonSESMediatorBase {
    ...
    protected final Map<String, String> getSingleValuedParametersMap() {
        ...
        parameterMap.put(AmazonSESConstants.API_EMAIL_ADDRESS, AmazonSESConstants.ESB_EMAIL_ADDRESS);
        return parameterMap;
    }
}
