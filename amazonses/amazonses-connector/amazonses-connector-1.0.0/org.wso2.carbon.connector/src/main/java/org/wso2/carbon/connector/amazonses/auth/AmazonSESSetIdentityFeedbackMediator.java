...
/**
 * The Class AmazonSESSetIdentityFeedbackMediator used for setIdentityFeedback method.
 */
public class AmazonSESSetIdentityFeedbackMediator extends AmazonSESMediatorBase {
    ...
    protected final Map<String, String> getSingleValuedParametersMap() {
        ...
        parameterMap.put(AmazonSESConstants.API_FORWARDING_ENABLED, AmazonSESConstants.ESB_FORWARDING_ENABLED);
        return parameterMap;
    }
}
