...
public class AmazonSESDeleteIdentityPolicyMediator extends AmazonSESMediatorBase {
    ...
    protected final Map<String, String> getSingleValuedParametersMap() {
        ...
        parameterMap.put(AmazonSESConstants.API_POLICY_NAME, AmazonSESConstants.ESB_POLICY_NAME);
        return parameterMap;
    }
}
