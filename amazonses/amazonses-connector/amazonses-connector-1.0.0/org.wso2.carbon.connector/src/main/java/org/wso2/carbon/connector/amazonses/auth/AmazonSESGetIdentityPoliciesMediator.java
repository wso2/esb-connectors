...
public class AmazonSESGetIdentityPoliciesMediator extends AmazonSESMediatorBase {
    /**
    ...
    protected final Map<String, String> getSingleValuedParametersMap() {
        ...
        parameterMap.put(AmazonSESConstants.API_POLICY_NAMES_MEMBER, AmazonSESConstants.ESB_POLICY_NAMES_MEMBER);
        return parameterMap;
    }
}
