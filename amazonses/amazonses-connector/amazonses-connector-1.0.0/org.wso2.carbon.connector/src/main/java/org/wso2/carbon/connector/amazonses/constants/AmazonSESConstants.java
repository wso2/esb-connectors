...
public final class AmazonSESConstants {
    ...
    /**
     * ESB and API constants for Policy_name_member.
     */
    public static final String ESB_POLICY_NAMES_MEMBER = "uri.var.policyNamesMember";

    /**
     * The Constant API_Policy_name_member.
     */
    public static final String API_POLICY_NAMES_MEMBER = "PolicyNames.member.1";

    /**
     * ESB and API constants for Rule_name_member.
     */
    public static final String ESB_RULE_NAMES_MEMBER = "uri.var.ruleNamesMember";

    /**
     * The Constant API_Rule_name_member.
     */
    public static final String API_RULE_NAMES_MEMBER = "RuleNames.member.1";

    /**
     * ESB and API constants for After.
     */
    public static final String ESB_AFTER = "uri.var.after";

    /**
     * The Constant API_AFTER.
     */
    public static final String API_AFTER = "AFTER";
    ...
    /**
     * ESB and API constants for Policy.
     */
    public static final String ESB_POLICY = "uri.var.policy";

    /**
     * The Constant API_Policy.
     */
    public static final String API_POLICY = "Policy";
    ...
    /**
     * ESB and API constants for PolicyName.
     */
    public static final String ESB_POLICY_NAME = "uri.var.policyName";

    /**
     * The Constant API_POLICY_NAME.
     */
    public static final String API_POLICY_NAME = "PolicyName";
    ...
    /**
     * ESB and API constants for RULE.
     */
    public static final String ESB_RECEIPT_RULE_NAME = "uri.var.ruleName";

    /**
     * The Constant API_RULE.
     */
    public static final String API_RECEIPT_RULE_NAME  = "RuleName";

    /**
     * ESB and API constants for RULE_SET.
     */
    public static final String ESB_RECEIPT_RULE_SET_NAME = "uri.var.ruleSetName";

    /**
     * The Constant API_RULE_SET.
     */
    public static final String API_RECEIPT_RULE_SET_NAME  = "RuleSetName";

    /**
     * ESB and API constants for RULE.
     */
    public static final String ESB_RECEIPT_RULE = "uri.var.rule";

    /**
     * The Constant API_RULE.
     */
    public static final String API_RECEIPT_RULE  = "Rule";
