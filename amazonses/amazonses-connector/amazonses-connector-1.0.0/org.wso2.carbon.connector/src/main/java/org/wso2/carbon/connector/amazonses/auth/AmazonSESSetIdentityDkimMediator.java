...
/**
 * The Class AmazonSESSetIdentityDkimMediator used for setIdentityDkim method.
 */
public class AmazonSESSetIdentityDkimMediator extends AmazonSESMediatorBase {
    ...
    protected final Map<String, String> getSingleValuedParametersMap() {
        ...
        parameterMap.put(AmazonSESConstants.API_DKIM_ENABLED, AmazonSESConstants.ESB_DKIM_ENABLED);
        return parameterMap;
    }
}
