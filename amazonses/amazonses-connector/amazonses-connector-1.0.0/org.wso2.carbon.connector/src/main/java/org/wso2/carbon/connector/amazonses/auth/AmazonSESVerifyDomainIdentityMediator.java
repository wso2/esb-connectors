...
/**
 * The Class AmazonSESVerifyDomainIdentityMediator used for verifyDomainIdentity method.
 */
public class AmazonSESVerifyDomainIdentityMediator extends AmazonSESMediatorBase {
    ...
    protected final Map<String, String> getSingleValuedParametersMap() {
        ...
        parameterMap.put(AmazonSESConstants.API_DOMAIN, AmazonSESConstants.ESB_DOMAIN);
        return parameterMap;
    }
}
