...
public final class AmazonSESConstants {
    ...
    /**
     * private constructor for AmazonSESConstants.
     */
    private AmazonSESConstants() {
     ...
     * Constant for the key to set the x-amz-date into MessageContext.
     */
    public static final String API_X_AMZ_DATE_HEADER_SET = "x-amz-date";

    /**
     * Constant for the key to set the X-Amzn-Authorization Header value into MessageContext.
     */
    public static final String API_X_AMZN_AUTHORIZATION_HEADER_SET = "X-Amzn-Authorization";
