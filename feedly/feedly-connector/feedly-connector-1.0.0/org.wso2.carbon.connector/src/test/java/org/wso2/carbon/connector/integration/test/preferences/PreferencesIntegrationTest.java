...
public class PreferencesIntegrationTest extends FeedlyConnectorIntegrationTest {
     ...
     */
    @Test(groups = { "wso2.esb" },priority = 41,enabled=true, description = "Feedly {getPreference} integration test.")
     ...
     */
    @Test(groups = { "wso2.esb" },priority = 42, enabled=true,description = "Feedly {getPreferenceNegative} integration test.")
     ...
     */
    @Test(groups = { "wso2.esb" },priority = 43,enabled=true, description = "Feedly {updatePreference} integration test.")
     ...
     */
    @Test(groups = { "wso2.esb" },priority = 44,enabled=true, description = "Feedly {updatePreferenceNegative} integration test.")
